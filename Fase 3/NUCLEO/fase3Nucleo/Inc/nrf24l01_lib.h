...
/* Flush FIFOs */
#define NRF24L01_FLUSH_TX					{ uint8_t flushTxMask = NRF24L01_FLUSH_TX_MASK; NRF24L01_CSN_LOW; HAL_SPI_Transmit(&hspi1, &flushTxMask, 1, 10); NRF24L01_CSN_HIGH; }
#define NRF24L01_FLUSH_RX					{ uint8_t flushRxMask = NRF24L01_FLUSH_RX_MASK; NRF24L01_CSN_LOW; HAL_SPI_Transmit(&hspi1, &flushRxMask, 1, 10); NRF24L01_CSN_HIGH; }
